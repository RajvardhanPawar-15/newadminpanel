    ...
    <>
      <div className="page-wrapper">
        <div className="content">
          <div className="page-header">
            <div className="add-item d-flex">
              <div className="page-title">
                <h4 className="text-lg font-bold">Create Category</h4>
                <h6 className="text-sm">Create new category</h6>
              </div>
            </div>
          ...
          >
            <h2 className="text-base font-bold p-2">Category Information</h2>
            <hr />
