    ...
    const fetchProductData = async () => {
      try {
        ...
        setFormData({
          ...
          season_flag: productData.season_flag || "",
          sku: productData.sku || "",
          description: productData.description || "",
          ingredients: productData.ingredients || "",
          cook_time: productData.cook_time?.toString() || "",
          ...
          is_veg: productData.is_veg || false,
        });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          `Failed to update product: ${JSON.stringify(errorData)}`
        );
      }
          ...
          <div className="page-header">
            <div className="add-item d-flex">
              <div className="page-title">
                ...
                <h6 className="text-sm">{formData.name}</h6>
              </div>
            </div>
